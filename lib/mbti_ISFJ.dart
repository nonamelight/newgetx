            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text('직장내 프론트엔드 개발자는 대게 기획에 따라 움직입니다. 웹 디자이너가 디자인에 대한 뼈대를 잡으면 퍼블리셔가 디자인에 관한 내용을 채워줍니다. 그러면 프론트엔드 개발자는 이렇게 설계된 디자인에 대한 효과를 넣어줍니다. 즉, 웹페이지의 전면부 효과를 개발하는 역할입니다. '),
                ),
                Container(
                  margin: EdgeInsets.only(
                    top: margin_main_panel * 2,
